...
class StartOffboarding(Tool):
    ...
    def _invoke_internal(payload: Dict[str, Any], db: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        if db is not None:
            ...
            request_id = StartOffboarding._generate_id(reqs)
    ...
    def invoke(data: Dict[str, Any], request_record: Dict[str, Any]) -> str:
        try:
            res = StartOffboarding._invoke_internal({"data_record": request_record}, db=data)
        except Exception as e:
    ...
    def get_info() -> Dict[str, Any]:
        return {"type": "function", "function": {"name": "start_offboarding", "description": "Create an offboarding request.", "parameters": {"type": "object", "properties": {"data": {"type": "dict"}, "request_record": {"type": "dict"}}, "required": ["data", "request_record"]}}}
