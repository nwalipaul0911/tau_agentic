...
class CreatePayrollBatch(Tool):
    ...
    def invoke(data: Dict[str, Any], run_id: str) -> str:
        try:
            res = CreatePayrollBatch._invoke_internal({"payroll_run_id": run_id}, db=data)
        except Exception as e:
    ...
    def get_info() -> Dict[str, Any]:
        return {"type": "function", "function": {"name": "create_payroll_batch", "description": "Generate employee pays for a payroll run.", "parameters": {"type": "object", "properties": {"data": {"type": "dict"}, "run_id": {"type": "string"}}, "required": ["data", "run_id"]}}}
