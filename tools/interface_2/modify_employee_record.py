...
class ModifyEmployeeRecord(Tool):
    @staticmethod
    ...
    def invoke(data: Dict[str, Any], employee_id: str, updates: Dict[str, Any]) -> str:
        try:
            res = ModifyEmployeeRecord._invoke_internal({"employee_id": employee_id, "updates": updates}, db=data)
        except Exception as e:
    ...
    def get_info() -> Dict[str, Any]:
        return {"type": "function", "function": {"name": "modify_employee_record", "description": "Update an employee record.", "parameters": {"type": "object", "properties": {"data": {"type": "dict"}, "employee_id": {"type": "string"}, "updates": {"type": "object"}}, "required": ["data", "employee_id", "updates"]}}}
