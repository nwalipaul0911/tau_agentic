...
class StartNewPayroll(Tool):
    ...
    def _invoke_internal(payload: Dict[str, Any], db: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        if db is not None:
            ...
            run_id = StartNewPayroll._generate_id(runs)
    ...
    def invoke(data: Dict[str, Any], run_record: Dict[str, Any]) -> str:
        try:
            res = StartNewPayroll._invoke_internal({"data_record": run_record}, db=data)
        except Exception as e:
    ...
    def get_info() -> Dict[str, Any]:
        return {"type": "function", "function": {"name": "start_new_payroll", "description": "Create a payroll run.", "parameters": {"type": "object", "properties": {"data": {"type": "dict"}, "run_record": {"type": "dict"}}, "required": ["data", "run_record"]}}}
