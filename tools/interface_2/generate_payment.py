...
class GeneratePayment(Tool):
    ...
    def _invoke_internal(payload: Dict[str, Any], db: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        if db is not None:
            ...
            pid = GeneratePayment._generate_id(payments)
    ...
    def invoke(data: Dict[str, Any], payment_record: Dict[str, Any]) -> str:
        try:
            res = GeneratePayment._invoke_internal({"data_record": payment_record}, db=data)
        except Exception as e:
    ...
    def get_info() -> Dict[str, Any]:
        return {"type": "function", "function": {"name": "generate_payment", "description": "Create a payment.", "parameters": {"type": "object", "properties": {"data": {"type": "dict"}, "payment_record": {"type": "dict"}}, "required": ["data", "payment_record"]}}}
