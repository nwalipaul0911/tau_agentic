...
class FetchInvoice(Tool):
    ...
    def invoke(data: Dict[str, Any], invoice_id: str) -> str:
        try:
            res = FetchInvoice._invoke_internal({"invoice_id": invoice_id}, db=data)
        except Exception as e:
    ...
    def get_info() -> Dict[str, Any]:
        return {"type": "function", "function": {"name": "fetch_invoice", "description": "Retrieve an invoice by invoice_id.", "parameters": {"type": "object", "properties": {"data": {"type": "dict"}, "invoice_id": {"type": "string"}}, "required": ["data", "invoice_id"]}}}
