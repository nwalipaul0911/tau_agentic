...
class FinalizeDispute(Tool):
    ...
    def invoke(data: Dict[str, Any], dispute_id: str, resolution: Dict[str, Any]) -> str:
        try:
            res = FinalizeDispute._invoke_internal({"dispute_id": dispute_id, "resolution": resolution}, db=data)
        except Exception as e:
    ...
    def get_info() -> Dict[str, Any]:
        return {"type": "function", "function": {"name": "finalize_dispute", "description": "Resolve a dispute.", "parameters": {"type": "object", "properties": {"data": {"type": "dict"}, "dispute_id": {"type": "string"}, "resolution": {"type": "dict"}}, "required": ["data", "dispute_id", "resolution"]}}}
