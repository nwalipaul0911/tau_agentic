...
class LookupEmployeePay(Tool):
    ...
    def invoke(data: Dict[str, Any], pay_id: str) -> str:
        try:
            res = LookupEmployeePay._invoke_internal({"pay_id": pay_id}, db=data)
        except Exception as e:
    ...
    def get_info() -> Dict[str, Any]:
        return {"type": "function", "function": {"name": "lookup_employee_pay", "description": "Retrieve an employee pay record by pay_id.", "parameters": {"type": "object", "properties": {"data": {"type": "dict"}, "pay_id": {"type": "string"}}, "required": ["data", "pay_id"]}}}
