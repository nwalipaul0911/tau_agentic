...
class EditPaymentDetails(Tool):
    ...
    def invoke(data: Dict[str, Any], payment_id: str, updates: Dict[str, Any]) -> str:
        try:
            res = EditPaymentDetails._invoke_internal({"payment_id": payment_id, "updates": updates}, db=data)
        except Exception as e:
    ...
    def get_info() -> Dict[str, Any]:
        return {"type": "function", "function": {"name": "edit_payment_details", "description": "Update a payment record.", "parameters": {"type": "object", "properties": {"data": {"type": "dict"}, "payment_id": {"type": "string"}, "updates": {"type": "object"}}, "required": ["data", "payment_id", "updates"]}}}
