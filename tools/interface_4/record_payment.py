...
class RecordPayment(Tool):
    ...
    def _invoke_internal(payload: Dict[str, Any], db: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        if db is not None:
            ...
            pid = RecordPayment._generate_id(payments)
    ...
    def invoke(data: Dict[str, Any], payment_record: Dict[str, Any]) -> str:
        try:
            res = RecordPayment._invoke_internal({"data_record": payment_record}, db=data)
        except Exception as e:
    ...
    def get_info() -> Dict[str, Any]:
        return {"type": "function", "function": {"name": "record_payment", "description": "Create a payment.", "parameters": {"type": "object", "properties": {"data": {"type": "dict"}, "payment_record": {"type": "dict"}}, "required": ["data", "payment_record"]}}}
