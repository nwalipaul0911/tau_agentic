...
class SetOnboardingRequestStatus(Tool):
    @staticmethod
    ...
    def invoke(data: Dict[str, Any], onboarding_id: str, updates: Dict[str, Any]) -> str:
        try:
            res = SetOnboardingRequestStatus._invoke_internal({"onboarding_id": onboarding_id, "updates": updates}, db=data)
        except Exception as e:
    ...
    def get_info() -> Dict[str, Any]:
        return {"type": "function", "function": {"name": "set_onboarding_request_status", "description": "Update an onboarding request.", "parameters": {"type": "object", "properties": {"data": {"type": "dict"}, "onboarding_id": {"type": "string"}, "updates": {"type": "object"}}, "required": ["data", "onboarding_id", "updates"]}}}
