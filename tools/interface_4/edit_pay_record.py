...
class EditPayRecord(Tool):
    ...
    def invoke(data: Dict[str, Any], employee_pay_id: str, updates: Dict[str, Any]) -> str:
        try:
            res = EditPayRecord._invoke_internal({"employee_pay_id": employee_pay_id, "updates": updates}, db=data)
        except Exception as e:
    ...
    def get_info() -> Dict[str, Any]:
        return {"type": "function", "function": {"name": "edit_pay_record", "description": "Update an employee pay record.", "parameters": {"type": "object", "properties": {"data": {"type": "dict"}, "employee_pay_id": {"type": "string"}, "updates": {"type": "object"}}, "required": ["data", "employee_pay_id", "updates"]}}}
