...
class LookupOrder(Tool):
    ...
    def invoke(data: Dict[str, Any], order_id: str) -> str:
        try:
            res = LookupOrder._invoke_internal({"order_id": order_id}, db=data)
        except Exception as e:
    ...
    def get_info() -> Dict[str, Any]:
        return {"type": "function", "function": {"name": "lookup_order", "description": "Retrieve an order by order_id.", "parameters": {"type": "object", "properties": {"data": {"type": "dict"}, "order_id": {"type": "string"}}, "required": ["data", "order_id"]}}}
