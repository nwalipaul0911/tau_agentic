...
class ChangeDisputeState(Tool):
    ...
    def invoke(data: Dict[str, Any], dispute_id: str, new_status: str) -> str:
        try:
            res = ChangeDisputeState._invoke_internal({"dispute_id": dispute_id, "status": new_status}, db=data)
        except Exception as e:
    ...
    def get_info() -> Dict[str, Any]:
        return {"type": "function", "function": {"name": "change_dispute_state", "description": "Update the status of a dispute.", "parameters": {"type": "object", "properties": {"data": {"type": "dict"}, "dispute_id": {"type": "string"}, "new_status": {"type": "string"}}, "required": ["data", "dispute_id", "new_status"]}}}
