...
class ChangeEmployeePayStatus(Tool):
    @staticmethod
    ...
    def invoke(data: Dict[str, Any], employee_pay_id: str, updates: Dict[str, Any]) -> str:
        try:
            res = ChangeEmployeePayStatus._invoke_internal({"employee_pay_id": employee_pay_id, "updates": updates}, db=data)
        except Exception as e:
    ...
    def get_info() -> Dict[str, Any]:
        return {"type": "function", "function": {"name": "change_employee_pay_status", "description": "Update an employee pay record.", "parameters": {"type": "object", "properties": {"data": {"type": "dict"}, "employee_pay_id": {"type": "string"}, "updates": {"type": "object"}}, "required": ["data", "employee_pay_id", "updates"]}}}
