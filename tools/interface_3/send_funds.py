...
class SendFunds(Tool):
    ...
    def invoke(data: Dict[str, Any], payment_request: Dict[str, Any]) -> str:
        try:
            res = SendFunds._invoke_internal({"payment_request": payment_request}, db=data)
        except Exception as e:
    ...
    def get_info() -> Dict[str, Any]:
        return {"type": "function", "function": {"name": "send_funds", "description": "Execute an external payment (simulated).", "parameters": {"type": "object", "properties": {"data": {"type": "dict"}, "payment_request": {"type": "dict"}}, "required": ["data", "payment_request"]}}}
