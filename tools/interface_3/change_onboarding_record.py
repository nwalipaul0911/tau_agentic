...
class ChangeOnboardingRecord(Tool):
    @staticmethod
    ...
    def invoke(data: Dict[str, Any], onboarding_id: str, updates: Dict[str, Any]) -> str:
        try:
            res = ChangeOnboardingRecord._invoke_internal({"onboarding_id": onboarding_id, "updates": updates}, db=data)
        except Exception as e:
    ...
    def get_info() -> Dict[str, Any]:
        return {"type": "function", "function": {"name": "change_onboarding_record", "description": "Update an onboarding request.", "parameters": {"type": "object", "properties": {"data": {"type": "dict"}, "onboarding_id": {"type": "string"}, "updates": {"type": "object"}}, "required": ["data", "onboarding_id", "updates"]}}}
