...
class ChangeVendorDetails(Tool):
    @staticmethod
    ...
    def invoke(data: Dict[str, Any], vendor_id: str, updates: Dict[str, Any]) -> str:
        try:
            res = ChangeVendorDetails._invoke_internal({"vendor_id": vendor_id, "updates": updates}, db=data)
        except Exception as e:
    ...
    def get_info() -> Dict[str, Any]:
        return {"type": "function", "function": {"name": "change_vendor_details", "description": "Update a vendor record.", "parameters": {"type": "object", "properties": {"data": {"type": "dict"}, "vendor_id": {"type": "string"}, "updates": {"type": "object"}}, "required": ["data", "vendor_id", "updates"]}}}
