...
class FindPayrollRunById(Tool):
    ...
    def invoke(data: Dict[str, Any], payroll_run_id: str) -> str:
        try:
            res = FindPayrollRunById._invoke_internal({"payroll_run_id": payroll_run_id}, db=data)
        except Exception as e:
    ...
    def get_info() -> Dict[str, Any]:
        return {"type": "function", "function": {"name": "find_payroll_run_by_id", "description": "Retrieve a payroll run by id.", "parameters": {"type": "object", "properties": {"data": {"type": "dict"}, "payroll_run_id": {"type": "string"}}, "required": ["data", "payroll_run_id"]}}}
