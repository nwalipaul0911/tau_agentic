...
class ReadInvoiceRecord(Tool):
    ...
    def invoke(data: Dict[str, Any], invoice_id: str) -> str:
        try:
            res = ReadInvoiceRecord._invoke_internal({"invoice_id": invoice_id}, db=data)
        except Exception as e:
    ...
    def get_info() -> Dict[str, Any]:
        return {"type": "function", "function": {"name": "read_invoice_record", "description": "Retrieve an invoice by invoice_id.", "parameters": {"type": "object", "properties": {"data": {"type": "dict"}, "invoice_id": {"type": "string"}}, "required": ["data", "invoice_id"]}}}
