...
class ReadOffboardingRecord(Tool):
    @staticmethod
    ...
    def invoke(data: Dict[str, Any], request_id: str) -> str:
        try:
            res = ReadOffboardingRecord._invoke_internal({"request_id": request_id}, db=data)
        except Exception as e:
    ...
    def get_info() -> Dict[str, Any]:
        return {"type": "function", "function": {"name": "read_offboarding_record", "description": "Retrieve an offboarding request by request_id.", "parameters": {"type": "object", "properties": {"data": {"type": "dict"}, "request_id": {"type": "string"}}, "required": ["data", "request_id"]}}}
