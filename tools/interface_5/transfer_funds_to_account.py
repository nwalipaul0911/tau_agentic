...
class TransferFundsToAccount(Tool):
    @staticmethod
    ...
    def invoke(data: Dict[str, Any], payment_request: Dict[str, Any]) -> str:
        try:
            res = TransferFundsToAccount._invoke_internal({"payment_request": payment_request}, db=data)
        except Exception as e:
    ...
    def get_info() -> Dict[str, Any]:
        return {"type": "function", "function": {"name": "transfer_funds_to_account", "description": "Execute an external payment (simulated).", "parameters": {"type": "object", "properties": {"data": {"type": "dict"}, "payment_request": {"type": "dict"}}, "required": ["data", "payment_request"]}}}
