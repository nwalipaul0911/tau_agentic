...
class ReadDepartmentRecord(Tool):
    @staticmethod
    ...
    def invoke(data: Dict[str, Any], department_id: str) -> str:
        try:
            res = ReadDepartmentRecord._invoke_internal({"department_id": department_id}, db=data)
        except Exception as e:
    ...
    def get_info() -> Dict[str, Any]:
        return {"type": "function", "function": {"name": "read_department_record", "description": "Retrieve a department by department_id.", "parameters": {"type": "object", "properties": {"data": {"type": "dict"}, "department_id": {"type": "string"}}, "required": ["data", "department_id"]}}}
