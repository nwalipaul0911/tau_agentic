...
class InitiateDisbursement(Tool):
    @staticmethod
    ...
    def _invoke_internal(payload: Dict[str, Any], db: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        if db is not None:
            ...
            pid = InitiateDisbursement._generate_id(payments)
    ...
    def invoke(data: Dict[str, Any], payment_record: Dict[str, Any]) -> str:
        try:
            res = InitiateDisbursement._invoke_internal({"data_record": payment_record}, db=data)
        except Exception as e:
    ...
    def get_info() -> Dict[str, Any]:
        return {"type": "function", "function": {"name": "initiate_disbursement", "description": "Create a payment.", "parameters": {"type": "object", "properties": {"data": {"type": "dict"}, "payment_record": {"type": "dict"}}, "required": ["data", "payment_record"]}}}
