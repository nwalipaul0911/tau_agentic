...
class ReadPaymentRecord(Tool):
    ...
    def invoke(data: Dict[str, Any], payment_id: str) -> str:
        try:
            res = ReadPaymentRecord._invoke_internal({"payment_id": payment_id}, db=data)
        except Exception as e:
    ...
    def get_info() -> Dict[str, Any]:
        return {"type": "function", "function": {"name": "read_payment_record", "description": "Retrieve a payment by payment_id.", "parameters": {"type": "object", "properties": {"data": {"type": "dict"}, "payment_id": {"type": "string"}}, "required": ["data", "payment_id"]}}}
