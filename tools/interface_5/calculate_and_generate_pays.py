...
class CalculateAndGeneratePays(Tool):
    @staticmethod
    ...
    def invoke(data: Dict[str, Any], run_id: str) -> str:
        try:
            res = CalculateAndGeneratePays._invoke_internal({"payroll_run_id": run_id}, db=data)
        except Exception as e:
    ...
    def get_info() -> Dict[str, Any]:
        return {"type": "function", "function": {"name": "calculate_and_generate_pays", "description": "Generate employee pays for a payroll run.", "parameters": {"type": "object", "properties": {"data": {"type": "dict"}, "run_id": {"type": "string"}}, "required": ["data", "run_id"]}}}
