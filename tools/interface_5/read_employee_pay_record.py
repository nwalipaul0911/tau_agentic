...
class ReadEmployeePayRecord(Tool):
    @staticmethod
    ...
    def invoke(data: Dict[str, Any], pay_id: str) -> str:
        try:
            res = ReadEmployeePayRecord._invoke_internal({"pay_id": pay_id}, db=data)
        except Exception as e:
    ...
    def get_info() -> Dict[str, Any]:
        return {"type": "function", "function": {"name": "read_employee_pay_record", "description": "Retrieve an employee pay record by pay_id.", "parameters": {"type": "object", "properties": {"data": {"type": "dict"}, "pay_id": {"type": "string"}}, "required": ["data", "pay_id"]}}}
