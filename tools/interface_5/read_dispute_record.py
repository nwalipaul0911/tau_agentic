...
class ReadDisputeRecord(Tool):
    ...
    def invoke(data: Dict[str, Any], dispute_id: str) -> str:
        try:
            res = ReadDisputeRecord._invoke_internal({"dispute_id": dispute_id}, db=data)
        except Exception as e:
    ...
    def get_info() -> Dict[str, Any]:
        return {"type": "function", "function": {"name": "read_dispute_record", "description": "Retrieve a dispute by dispute_id.", "parameters": {"type": "object", "properties": {"data": {"type": "dict"}, "dispute_id": {"type": "string"}}, "required": ["data", "dispute_id"]}}}
